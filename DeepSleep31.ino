...
void setup() {
  ...
  writeByte(MPU6050_ADDR, MPU60X0_RA_INT_ENABLE, 0x00); //write register 0x38, 0x00, to disable motion detection interrupt?
  int_time = millis();
...
void mpu_set_int (){
  ...
  writeByte(MPU6050_ADDR, 0x37, 160-32); // now INT pin is active low, and latch is false?
